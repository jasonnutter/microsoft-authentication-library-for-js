...
import { ClientConfigurationError, ClientConfigurationErrorMessage } from "../../error/ClientConfigurationError";
...
export class AuthorizationCodeModule extends AuthModule {
    ...
    private getCachedRequest(codeResponse: CodeResponse): TokenExchangeParameters {
        try {
            ...
            // Get authority from code response and use in new request
